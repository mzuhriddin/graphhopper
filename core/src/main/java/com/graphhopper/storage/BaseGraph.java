...
public class BaseGraph implements Graph, Closeable {
    ...
    static class EdgeIteratorStateImpl implements EdgeIteratorState {
        ...
        public boolean get(BooleanEncodedValue property) {
            return property.getBool(reverse, edgeId, getFlags());
        }

        @Override
        public EdgeIteratorState set(BooleanEncodedValue property, boolean value) {
            property.setBool(reverse, edgeId, getFlags(), value);
        ...
        public EdgeIteratorState set(BooleanEncodedValue property, boolean fwd, boolean bwd) {
            ...
            property.setBool(reverse, edgeId, getFlags(), fwd);
            property.setBool(!reverse, edgeId, getFlags(), bwd);
            store.writeFlags(edgePointer, getFlags());
            return this;
        }
        ...
        public int get(IntEncodedValue property) {
            return property.getInt(reverse, edgeId, getFlags());
        }

        @Override
        public EdgeIteratorState set(IntEncodedValue property, int value) {
            property.setInt(reverse, edgeId, getFlags(), value);
            store.writeFlags(edgePointer, getFlags());
            return this;
        }
        ...
        public EdgeIteratorState set(IntEncodedValue property, int fwd, int bwd) {
            if (!property.isStoreTwoDirections())
                throw new IllegalArgumentException("EncodedValue " + property.getName() + " supports only one direction");
            property.setInt(reverse, edgeId, getFlags(), fwd);
            property.setInt(!reverse, edgeId, getFlags(), bwd);
            store.writeFlags(edgePointer, getFlags());
            return this;
        }
        ...
        public double get(DecimalEncodedValue property) {
            return property.getDecimal(reverse, edgeId, getFlags());
        }

        @Override
        public EdgeIteratorState set(DecimalEncodedValue property, double value) {
            property.setDecimal(reverse, edgeId, getFlags(), value);
            store.writeFlags(edgePointer, getFlags());
            return this;
        }
        ...
        public EdgeIteratorState set(DecimalEncodedValue property, double fwd, double bwd) {
            if (!property.isStoreTwoDirections())
                throw new IllegalArgumentException("EncodedValue " + property.getName() + " supports only one direction");
            property.setDecimal(reverse, edgeId, getFlags(), fwd);
            property.setDecimal(!reverse, edgeId, getFlags(), bwd);
            store.writeFlags(edgePointer, getFlags());
            return this;
        }
        ...
        public <T extends Enum<?>> T get(EnumEncodedValue<T> property) {
            return property.getEnum(reverse, edgeId, getFlags());
        }

        @Override
        public <T extends Enum<?>> EdgeIteratorState set(EnumEncodedValue<T> property, T value) {
            property.setEnum(reverse, edgeId, getFlags(), value);
            store.writeFlags(edgePointer, getFlags());
            return this;
        }
        ...
        public <T extends Enum<?>> EdgeIteratorState set(EnumEncodedValue<T> property, T fwd, T bwd) {
            if (!property.isStoreTwoDirections())
                throw new IllegalArgumentException("EncodedValue " + property.getName() + " supports only one direction");
            property.setEnum(reverse, edgeId, getFlags(), fwd);
            property.setEnum(!reverse, edgeId, getFlags(), bwd);
            store.writeFlags(edgePointer, getFlags());
            return this;
        }
        ...
        public String get(StringEncodedValue property) {
            return property.getString(reverse, edgeId, getFlags());
        }

        @Override
        public EdgeIteratorState set(StringEncodedValue property, String value) {
            property.setString(reverse, edgeId, getFlags(), value);
            store.writeFlags(edgePointer, getFlags());
            return this;
        }
        ...
        public EdgeIteratorState set(StringEncodedValue property, String fwd, String bwd) {
            if (!property.isStoreTwoDirections())
                throw new IllegalArgumentException("EncodedValue " + property.getName() + " supports only one direction");
            property.setString(reverse, edgeId, getFlags(), fwd);
            property.setString(!reverse, edgeId, getFlags(), bwd);
            store.writeFlags(edgePointer, getFlags());
            return this;
        }
