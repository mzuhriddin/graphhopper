...
public final class DecimalEncodedValueImpl extends IntEncodedValueImpl implements DecimalEncodedValue {
    ...
    public void setDecimal(boolean reverse, int edgeId, IntsRef ref, double value) {
        ...
        super.uncheckedSet(reverse, edgeId, ref, (int) Math.round(value));
    }

    @Override
    public double getDecimal(boolean reverse, int edgeId, IntsRef ref) {
        int value = getInt(reverse, edgeId, ref);
