 ...
 */
public final class IntsRefImpl implements IntsRef, Comparable<IntsRefImpl> {
    /**
     * An IntsRef with an array of size 0.
     */
    public static final IntsRefImpl EMPTY = new IntsRefImpl(0, false);
    /**
     ...
     */
    public IntsRefImpl(int capacity) {
        this(capacity, true);
    }

    private IntsRefImpl(int capacity, boolean checked) {
     ...
     */
    public IntsRefImpl(int[] ints, int offset, int length) {
        this.ints = ints;
        this.offset = offset;
        this.length = length;
        assert isValid();
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof IntsRefImpl) {
            return this.intsEquals((IntsRefImpl) other);
        }
        return false;
    }

    public boolean intsEquals(IntsRefImpl other) {
     ...
     */
    @Override
    public int compareTo(IntsRefImpl other) {
     ...
     */
    public static IntsRefImpl deepCopyOf(IntsRefImpl other) {
        return new IntsRefImpl(Arrays.copyOfRange(other.ints, other.offset, other.offset + other.length), 0, other.length);
    }
