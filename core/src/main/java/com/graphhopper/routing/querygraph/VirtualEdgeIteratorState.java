...
public class VirtualEdgeIteratorState implements EdgeIteratorState {
    ...
    public boolean get(BooleanEncodedValue property) {
        ...
        return property.getBool(reverse, getEdge(), edgeFlags);
    }

    @Override
    public EdgeIteratorState set(BooleanEncodedValue property, boolean value) {
        property.setBool(reverse, getEdge(), edgeFlags, value);
        return this;
    }
    ...
    public EdgeIteratorState set(BooleanEncodedValue property, boolean fwd, boolean bwd) {
        ...
        property.setBool(reverse, getEdge(), edgeFlags, fwd);
        property.setBool(!reverse, getEdge(), edgeFlags, bwd);
        return this;
    }

    @Override
    public int get(IntEncodedValue property) {
        return property.getInt(reverse, getEdge(), edgeFlags);
    }

    @Override
    public EdgeIteratorState set(IntEncodedValue property, int value) {
        property.setInt(reverse, getEdge(), edgeFlags, value);
        return this;
    }
    ...
    public EdgeIteratorState set(IntEncodedValue property, int fwd, int bwd) {
        if (!property.isStoreTwoDirections())
            throw new IllegalArgumentException("EncodedValue " + property.getName() + " supports only one direction");
        property.setInt(reverse, getEdge(), edgeFlags, fwd);
        property.setInt(!reverse, getEdge(), edgeFlags, bwd);
        return this;
    }

    @Override
    public double get(DecimalEncodedValue property) {
        return property.getDecimal(reverse, getEdge(), edgeFlags);
    }

    @Override
    public EdgeIteratorState set(DecimalEncodedValue property, double value) {
        property.setDecimal(reverse, getEdge(), edgeFlags, value);
        return this;
    }
    ...
    public EdgeIteratorState set(DecimalEncodedValue property, double fwd, double bwd) {
        if (!property.isStoreTwoDirections())
            throw new IllegalArgumentException("EncodedValue " + property.getName() + " supports only one direction");
        property.setDecimal(reverse, getEdge(), edgeFlags, fwd);
        property.setDecimal(!reverse, getEdge(), edgeFlags, bwd);
        return this;
    }

    @Override
    public <T extends Enum<?>> T get(EnumEncodedValue<T> property) {
        return property.getEnum(reverse, getEdge(), edgeFlags);
    }

    @Override
    public <T extends Enum<?>> EdgeIteratorState set(EnumEncodedValue<T> property, T value) {
        property.setEnum(reverse, getEdge(), edgeFlags, value);
        return this;
    }
    ...
    public <T extends Enum<?>> EdgeIteratorState set(EnumEncodedValue<T> property, T fwd, T bwd) {
        if (!property.isStoreTwoDirections())
            throw new IllegalArgumentException("EncodedValue " + property.getName() + " supports only one direction");
        property.setEnum(reverse, getEdge(), edgeFlags, fwd);
        property.setEnum(!reverse, getEdge(), edgeFlags, bwd);
        return this;
    }

    @Override
    public String get(StringEncodedValue property) {
        return property.getString(reverse, getEdge(), edgeFlags);
    }

    @Override
    public EdgeIteratorState set(StringEncodedValue property, String value) {
        property.setString(reverse, getEdge(), edgeFlags, value);
        return this;
    }
    ...
    public EdgeIteratorState set(StringEncodedValue property, String fwd, String bwd) {
        if (!property.isStoreTwoDirections())
            throw new IllegalArgumentException("EncodedValue " + property.getName() + " supports only one direction");
        property.setString(reverse, getEdge(), edgeFlags, fwd);
        property.setString(!reverse, getEdge(), edgeFlags, bwd);
        return this;
    }
